...
<head>
    ...
    <title>Lilac Laravel Machine Test By Irfan</title>
    ...
    <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center selection:bg-red-500 selection:text-white">
        <div class="container">
            ...
            <div class="max-w-7xl mx-auto p-6 lg:p-8">
                <div class="flex justify-center col-11">
                    <input id="search-input" type="text" name="search" value="{{$search??''}}" placeholder="Search name/designation/department " class="form-control col-10" />
                </div>
                ...
                <div class="flex justify-center mt-16 px-0 sm:items-center sm:justify-between">
                    ...
                    <div class="text-center text-sm text-gray-500 dark:text-gray-400 sm:text-right sm:ml-0">
                        Lilac Laravel Machine Test By Irfan
                    </div>
                </div>
            </div>
        </div>
